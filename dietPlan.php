<?php
   ...
   else { $msg = "You are on show diet plan page"; }
   
    

   //Sending data to server
   $request = array();
   $request['type'] = "showMealPlan";
   ...
   $welcome = '<font size = "10" color = "coloring"> Your Saved diet plan list for';
   echo "<div align='center'><br><br>$welcome $day $response</div>";
